  ...
  if (open) {
    return (
      <svg width="14" height="12" viewBox="0 0 14 12" fill="currentColor">
        <path d="M0 3.5C0 2.67.67 2 1.5 2H5l1 1.5h6.5c.83 0 1.5.67 1.5 1.5V4H0V3.5z" opacity="0.85"/>
        <path d="M0 4h14l-1.2 6.8c-.12.69-.73 1.2-1.43 1.2H2.63c-.7 0-1.31-.51-1.43-1.2L0 4z"/>
      </svg>
    );
  }
  return (
    <svg width="14" height="12" viewBox="0 0 14 12" fill="currentColor">
      <path d="M0 3.5C0 2.67.67 2 1.5 2H5l1 1.5h6.5c.83 0 1.5.67 1.5 1.5V10c0 .83-.67 1.5-1.5 1.5h-11C.67 11.5 0 10.83 0 10V3.5z"/>
    </svg>
  );
}
